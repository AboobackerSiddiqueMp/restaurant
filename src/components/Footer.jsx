...
function Footer() {
  return (
    <div>
          <div style={{marginTop:'30px'}} className='bg-primary '>
      <div className='d-flex justify-content-center alig-items-center '>
        <div className="footer d-flex justify-content-evenly alig-items-center mt-5 p-0  " >
          <div className="website " style={{ width: '400px' }}>
            <h5><i class="fa-solid fa-bowl-food"></i>Food-Circle</h5>
